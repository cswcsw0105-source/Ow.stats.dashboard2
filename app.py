...
# 캐릭터별, 시즌별 패치 노트 및 메타 데이터베이스
patch_and_meta_data = {
    "캐서디": {
        "16시즌": "✅ **[버프/메타]** 생존력과 데미지 포텐셜이 매우 좋았던 전성기.\n\n🔥 **[분석]** KDA 3.82라는 경이로운 수치가 증명합니다. 메타가 받쳐줄 때 선웅님의 캐서디 피지컬이 얼마나 압도적인지 보여주는 시즌입니다. 에임과 생존 모두 완벽했습니다.",
        "19시즌": "🔻 **[너프/메타]** 윈스턴, 겐지 등 다이브 조합의 득세로 뚜벅이 딜러들의 생존이 극도로 힘들어진 '억까' 메타.\n\n💡 **[분석]** 7시간이나 플레이하며 명중률은 16시즌과 동일한 53%를 방어해 냈습니다. 에임은 훌륭했으나, KDA가 2.55로 떨어진 것은 팀의 케어 부족과 다이브 메타의 희생양이 되었기 때문입니다. 실력 하락이 아닌 환경의 문제입니다."
    },
    "아나": {
        "19시즌": "✅ **[메타]** 힐 밴과 수면총의 밸류가 그 어느 때보다 중요했던 시즌.\n\n🔥 **[분석]** 5시간 동안 14승을 챙기며 명중률 62%를 기록했습니다. 암살자들이 날뛰는 메타 속에서도 묵묵히 팀의 척추 역할을 완벽하게 수행해 냈습니다."
    }
}
